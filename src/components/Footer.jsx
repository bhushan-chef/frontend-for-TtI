  ...
  return (
    <div className='flex items-center justify-between gap-4 py-3 mt-20'>
        ...
        <p className='flex-1 border-gray-400 pl-4 text-sm text-gray-500 max-sm:hidden'>
            Copyright © 2025 All rights reserved | This template is made with <span className='text-red-500'>❤</span> by <a href="" className='text-blue-500 hover:underline' target='_blank'>Team AI</a>
        </p>
